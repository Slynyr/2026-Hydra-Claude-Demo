...
public final class Constants {
     ...
     * elsewhere. This allows for hardware changes to be easily implemented.
     */
    ...
    public enum ClimbingPositions {
        RIGHT(new Pose2d(
                new Translation2d(
                        ...
                        Meters.of(FieldConstants.Tower.rightUpright.getY()
        ...
        LEFT(new Pose2d(
                new Translation2d(
                        ...
                        Meters.of(FieldConstants.Tower.leftUpright.getY()
                                  + (DriveConstants.ROBOT_WIDTH.in(Meters) / 2)
                                  + kAutoAlign.CLIMBER_DISTANCE_FROM_UPRIGHT.in(Meters)
                        )
                ),
    ...
    public static final class kBump {
         ...
         */
        public static final double         BUMP_SPEED_MODIFIER  = 0.8;
